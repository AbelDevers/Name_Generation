import numpy as np
import pickle
import features_function_backward as ff
import random
...
pickle.dump(trainData, open("train_backward_"+cc_fips+".p", "wb"))

testData = [test_x, test_y]
pickle.dump(testData, open("test_backward_"+cc_fips+".p", "wb"))


# features = features_x
#
# print(cityName)
# print("Number of city", len(cityName))
# print(features,type(features))
# print("length", len(features))
# print("length2", len(features[1]))
#
# print("length3", len(features[0]))
